...
public class DisposeServlet extends HttpServlet {
	...
	throws ServletException, IOException {
			...
			UserInfo userInfo = new UserInfo(job,userName,userPasw,realName,tel,userHead,email,QQ,weChat,urgency_name,urgency_tel,
	...
	public void modifyUser(HttpServletRequest req, HttpServletResponse resp)
		...
		String dataState= req.getParameter("dataState");
		int role_id = Integer.parseInt(req.getParameter("role_id"));
		UserInfo userInfo = new UserInfo(u_id,job,userName,userPasw,realName,tel,userHead,email,QQ,weChat,urgency_name,urgency_tel,
										department_id,hiredate,dataState,role_id);
	...
	public void showDept(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			//查询每页信息
			List<Department> list = dtbean.showDeptOnPage(dept, pageNumber, pageSize);
			Map<String,Object> map = new HashMap<String, Object>();
			map.put("total", total);
			map.put("rows", list);
			resp.getWriter().write(JSONObject.fromObject(map).toString());
	...
	public void addDept(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			Department deptp = new Department(d_name,manage_id,d_describe,deptState);
	...
	public void addProduct(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			product = new Product(p_name,recommendDoctor,p_describe,createTime,p_state);
	...
	public void modifyProduct(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			product = new Product(p_id,p_name,recommendDoctor,p_describe,createTime,p_state);
	...
	throws ServletException, IOException {
		...
		elient = new Elient(manke,e_name,e_sex,e_tel,e_source,QQ,consultProduct,counselor,turnover,totalMoney,detailedAddress,arrivalDate,revisitDays,data);
		eb.addElient(elient);
	}
	/**
	 ...
	 * @throws IOException
	 */
	public void addReeord(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			Record  record = new Record(user_id,elient_id,progress,progressInfo,trackingDate,returnDate);
			rb.addRecord(record);
	...
	throws ServletException, IOException {
		...
		String trackingDate = req.getParameter("trackingDate");
		String returnDate = req.getParameter("returnDate");
		record = new Record(id,user_id,elient_id,Mprogress,progressInfo,trackingDate,returnDate);
